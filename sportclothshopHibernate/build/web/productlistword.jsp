...
<html>
    ...
    <body>
        <h1>Product Word List</h1>
        <%
            try {

                List<Product> productListWord = (List<Product>) session.getAttribute("searchResult");

                if (productListWord != null) {
        ...
        <table border="1">
            ...
            <tbody>
                ...
                <%                        for (Product acc : productListWord) {
                %>
                <tr>
